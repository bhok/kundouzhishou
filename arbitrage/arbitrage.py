...
def run():
	exchange_yunbi = yunbi_wrapper("ethcny", _get_value('yunbi','apikey'), _get_value('yunbi','secret'))
	exchange_poloniex = poloniex_wrapper("BTC_ETH", _get_value('poloniex','apikey'), _get_value('poloniex','secret'))
